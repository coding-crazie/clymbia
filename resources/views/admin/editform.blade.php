                        ...
                        <div class="bg-secondary rounded h-100 p-4">
                            ...
                            @endif
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="exampleInputPassword1" name="password"  value="{{$users->password}}"> 
                                </div>  
                                {{-- <div class="mb-3">
                                    <label for="exampleInputPassword1" class="form-label">balance</label>
                                    <input type="password" class="form-control" id="exampleInputPassword1" name="balance"  value="{{$users->balance}}"> 
                                </div> --}}
