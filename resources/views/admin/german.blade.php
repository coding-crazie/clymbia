        ...
        <div class="content">
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-secondary text-center rounded p-4">
                    ...
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        {{-- <h6 class="mb-0">Recent Salse</h6> --}}
                        <a href="{{url('update-balance-german')}}" class="btn btn-sm btn-warning">Add Balance At One click</a>
                    </div>
                    @endif
                    ...
                    @endif --}}
                        ...
                        @foreach ($users as $user )
                                ...
                                <tr>
                                    ...
                                    <td><a class="btn btn-sm btn-success" href="{{url('admin-edit',$user->id)}}">Edit</a></td>

                                    <td><a class="btn btn-sm btn-primary" href="{{url('admin-delete',$user->id)}}">Delete</a></td>
                                    <td><a class="btn btn-sm btn-warning" href="{{url('add-balance-german',$user->email)}}">Add Balance</a></td>
                                </tr>
