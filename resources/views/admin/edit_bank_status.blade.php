...
<script>
  ...
  gtag('config', 'G-3KZV2TPM7F');
    ...
    <meta charset="utf-8">
    <title>Admin Panel - Edit WithDraw Status</title>
                ...
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-secondary rounded h-100 p-4">
                            ...
                            <a href="{{url('/users-banks')}}" type="submit" class="btn btn-warning" >Back </a>
                                <br>
                                <br>
                            ...
                            @endif
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="exampleInputEmail1" name="status"  value="{{$banks->status}}"
