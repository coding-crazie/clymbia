                ...
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-secondary rounded h-100 p-4">
                            <h6 class="mb-4">Add  Balance</h6>
                            <a href="{{url('/admins')}}" type="submit" class="btn btn-warning" >Back </a>
                                <br>
                                <br>

                            <form  action="{{route('germanBalance')}}" method="POST">
                                @csrf
                                @method('PUT')
                            ...
                            @endif
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="exampleInputPassword1" name="balance"  > 
                                </div>
