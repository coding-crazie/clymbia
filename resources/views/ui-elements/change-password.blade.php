...
<head>
    ...
    <title>::Refundments:: ForgotPassword</title>
                    ...
                    <div class="row g-3">
                        <div class="col-lg-6 d-flex justify-content-center align-items-center auth-h100">
                            <div class="d-flex flex-column">
                                ...
                                <ul class="nav nav-pills mt-4" role="tablist">
                                    <li class="nav-item"><a class="nav-link active" href="{{url('/dashboard')}}" >Back to Dashboard</a></li>
                                    ...
                                    <div class="tab-pane fade show active" >
                                        <div class="card">
                                            <div class="card-body p-4">
                                                ...
                                                @endif
                                                    <div class="mb-3">
                                                        <label class="form-label fs-6">Old Password</label>
                                                    ...
                                                    <button class="btn btn-primary text-uppercase py-2 fs-5 w-100 mt-2">Submit</button>
                                                </form>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        {{-- <div class="col-lg-6 d-none d-lg-flex justify-content-center align-items-center auth-h100">
                            <div class="qr-block text-center">
                                <img src="side-page-assets/images/qr-code.png" alt="#" class="img-fluid my-4">
