...
<head>
    ...
    <title>::Cryptoon:: Changelog </title>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body text-center p-5">
                                    <img src="side-page-assets/images/change-log.svg" class="img-fluid mx-size" alt="No Data">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="pt-2">
                                        ...
                                        <span class="text-muted">&nbsp;&nbsp;&nbsp;–- June 01, 2022</span>
                                                
                                        <ul class="ms-5">
                                            <li>Add New Page "Support Ticket"</li>
                                        </ul>
                                    </div>
                                    <div class="pt-2">
                                        <h6 class="d-inline-block"><span class="badge bg-warning font-weight-light">v1.1.0</span></h6>
                                        <span class="text-muted">&nbsp;&nbsp;&nbsp;–- March 02, 2022</span>
                                    ...
                                    <div class="pt-2">
                                        ...
                                        <span class="text-muted">&nbsp;&nbsp;&nbsp;–- November 12, 2021</span>
                                        <ul class="ms-5">
