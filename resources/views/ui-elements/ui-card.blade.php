...
<head>
    ...
    <title>::Refundments:: Ui Card </title>
    <link rel="icon" href="/images/logo.png" type="image/x-icon"> <!-- Favicon-->

    <!-- Plugin css -->
    <link rel="stylesheet" href="side-page-assets/plugin/prism/prism.css">
...
<body>
            ...
            <div class="d-flex flex-column h-100">
                ...
                <a href="{{url("")}}" class="mb-0 brand-icon">
                    <span class="logo-icon">
                        <i > <img src="/images/logo.png" width="200px" alt=""></i>
                    </span>
                ...
                <ul class="menu-list flex-grow-1 mt-4 px-1">
                    ...
                    <li>
                        <a class="m-link active" href="{{url("/exchange")}}">
                            <svg xmlns="http://www.w3.org/2000/svg"  x="0px" y="0px" width="24px" height="24px" viewBox="0 0 38 38">
                    ...
                    <li>
                        <a class="m-link" href="{{url("/market")}}">
                    ...
                    <li>
                        <a class="m-link" href="{{url("/future")}}">
                            <svg  xmlns="http://www.w3.org/2000/svg"  x="0px" y="0px" width="24px" height="24px" viewBox="0 0 64 64">
                    ...
                    <li>
                        <a class="m-link" href="{{url("/battle")}}">
                            <svg  xmlns="http://www.w3.org/2000/svg"  x="0px" y="0px" width="24px" height="24px" viewBox="0 0 64 64">
                    ...
                    <li class="collapsed">
                        ...
                        <ul class="sub-menu collapse" id="trade">
                            <li><a class="ms-link" href="{{url("/convert-trade")}}">Convert</a></li>
                            
                            <li><a class="ms-link" href="{{url("/margin-trade")}}">Margin</a></li>
                    ...
                    <li class="collapsed">
                        ...
                        <ul class="sub-menu collapse" id="finace">
                            <li><a class="ms-link" href="{{url("/cryptoloan")}}">Crypto Loan</a></li>
                            <li><a class="ms-link" href="{{url("/cryptoonpay")}}">Cryptoon Pay</a></li>
                    ...
                    <nav class="navbar py-4">
                        <div class="container-xxl">
                            ...
                            <div class="h-right d-flex align-items-center mr-5 mr-lg-0 order-1">
                                <div class="d-flex">
                                    <a class="nav-link text-primary collapsed" href="{{url("/wallet")}}" title="Wallet">
                                                    ...
                                                    <ul class="list-unstyled list mb-0">
                                                        <li class="py-2 mb-1 border-bottom">
                                                            <a href="javascript:void(0);" class="d-flex">
                                                                <img class="avatar rounded-circle" src="profile-assets/images/xs/avatar1.svg" alt="">
                                                        ...
                                                        <li class="py-2 mb-1 border-bottom">
                                                            <a href="javascript:void(0);" class="d-flex">
                                                                <img class="avatar rounded-circle" src="profile-assets/images/xs/avatar3.svg" alt="">
                                                                <div class="flex-fill ms-2">
                                                        ...
                                                        <li class="py-2 mb-1 border-bottom">
                                                            <a href="javascript:void(0);" class="d-flex">
                                                                <img class="avatar rounded-circle" src="profile-assets/images/xs/avatar5.svg" alt="">
                                                                <div class="flex-fill ms-2">
                                                        ...
                                                        <li class="py-2 mb-1 border-bottom">
                                                            <a href="javascript:void(0);" class="d-flex">
                                                                <img class="avatar rounded-circle" src="profile-assets/images/xs/avatar6.svg" alt="">
                                                                <div class="flex-fill ms-2">
                                                        ...
                                                        <li class="py-2">
                                                            <a href="javascript:void(0);" class="d-flex">
                                                                <img class="avatar rounded-circle" src="profile-assets/images/xs/avatar7.svg" alt="">
                                                                <div class="flex-fill ms-2">
                                ...
                                <div class="dropdown zindex-popover">
                                    <a class="nav-link dropdown-toggle pulse" href="#" role="button" data-bs-toggle="dropdown">
                                        <img src="../dist/profile-assets/images/flag/GB.png" alt="">
                                    </a>
                                    <div class="dropdown-menu rounded-lg shadow border-0 dropdown-animation dropdown-menu-md-end p-0 m-0">
                                        <div class="card border-0">
                                            <ul class="list-unstyled py-2 px-3">
                                                <li>
                                                    <a href="#" class=""><img src="../dist/profile-assets/images/flag/GB.png" alt=""> English</a>
                                                </li>
                                                <li>
                                                    <a href="#" class=""><img src="../dist/profile-assets/images/flag/DE.png" alt=""> German</a>
                                                </li>
                                                <li>
                                                    <a href="#" class=""><img src="../dist/profile-assets/images/flag/FR.png" alt=""> French</a>
                                                </li>
                                                <li>
                                                    <a href="#" class=""><img src="../dist/profile-assets/images/flag/IT.png" alt=""> Italian</a>
                                                </li>
                                                <li>
                                                    <a href="#" class=""><img src="../dist/profile-assets/images/flag/RU.png" alt=""> Russian</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                ...
                                <div class="dropdown user-profile ml-2 ml-sm-3 d-flex align-items-center zindex-popover">
                                    <a class="nav-link dropdown-toggle pulse p-0" href="#" role="button" data-bs-toggle="dropdown" data-bs-display="static">
                                        <img class="avatar lg rounded-circle img-thumbnail" src="profile-assets/images/profile_av.svg" alt="profile">
                                    </a>
                                    <div class="dropdown-menu rounded-lg shadow border-0 dropdown-animation dropdown-menu-end p-0 m-0">
                                        <div class="card border-0 w280">
                                            ...
                                            <div class="list-group m-2 ">
                                                ...
                                                <a href="{{url("/admin")}}" class="list-group-item list-group-item-action border-0">
                                                ...
                                                <a href="{{url("/profile")}}" class="list-group-item list-group-item-action border-0">
                                                    <svg xmlns="http://www.w3.org/2000/svg"  x="0px" y="0px" width="24px" height="24px" viewBox="0 0 38 38" class="me-3">
                                                        <path xmlns="http://www.w3.org/2000/svg"   d="M36.15,38H1.85l0.16-1.14c0.92-6.471,3.33-7.46,6.65-8.83c0.43-0.17,0.87-0.36,1.34-0.561  c0.19-0.08,0.38-0.17,0.58-0.26c1.32-0.61,2.14-1.05,2.64-1.45c0.18,0.48,0.47,1.13,0.93,1.78C15.03,28.78,16.53,30,19,30  c2.47,0,3.97-1.22,4.85-2.46c0.46-0.65,0.75-1.3,0.931-1.78c0.5,0.4,1.319,0.84,2.64,1.45c0.2,0.09,0.39,0.17,0.58,0.26  c0.47,0.2,0.91,0.391,1.34,0.561c3.32,1.37,5.73,2.359,6.65,8.83L36.15,38z M20,13v4h-2v-4H20z" style="fill:var(--primary-color);" data-st="fill:var(--chart-color4);"></path>
                                                        <path xmlns="http://www.w3.org/2000/svg" class="st0" d="M21.67,17.34C21.22,18.27,20.29,19,19,19s-2.22-0.73-2.67-1.66l-1.79,0.891C15.31,19.78,16.88,21,19,21  s3.69-1.22,4.46-2.77L21.67,17.34z M15,10.85c-0.61,0-1.1,0.38-1.1,1.65s0.49,1.65,1.1,1.65s1.1-0.38,1.1-1.65S15.61,10.85,15,10.85  z M23,10.85c-0.61,0-1.1,0.38-1.1,1.65s0.489,1.65,1.1,1.65s1.1-0.38,1.1-1.65S23.61,10.85,23,10.85z M35.99,36.86  c-0.92-6.471-3.33-7.46-6.65-8.83c-0.43-0.17-0.87-0.36-1.34-0.561c-0.19-0.09-0.38-0.17-0.58-0.26c-1.32-0.61-2.14-1.05-2.64-1.45  c-0.521-0.42-0.7-0.8-0.761-1.29C26.55,22.74,28,19.8,28,17V4.56l-1.18,0.21C26.1,4.91,25.58,5,25.05,5  c-1.439,0-2.37-0.24-3.35-0.49C20.71,4.26,19.68,4,18.21,4c-1.54,0-2.94,0.69-3.83,1.9l1.61,1.18C16.5,6.39,17.31,6,18.21,6  c1.22,0,2.08,0.22,3,0.45C22.22,6.71,23.36,7,25.05,7c0.32,0,0.63-0.02,0.95-0.06V17c0,3.44-2.62,7-7,7s-7-3.56-7-7V6.29  C12.23,5.59,13.61,2,18.21,2c1.61,0,2.76,0.28,3.88,0.55C23.06,2.78,23.98,3,25.05,3C26.12,3,27.19,2.74,28,2.47V0.34  C27.34,0.61,26.17,1,25.05,1c-0.83,0-1.6-0.18-2.49-0.4C21.38,0.32,20.05,0,18.21,0c-5.24,0-7.64,3.86-8.18,5.89L10,17  c0,2.8,1.45,5.74,3.98,7.47c-0.06,0.49-0.24,0.87-0.76,1.29c-0.5,0.4-1.32,0.84-2.64,1.45c-0.2,0.09-0.39,0.18-0.58,0.26  c-0.47,0.2-0.91,0.391-1.34,0.561c-3.32,1.37-5.73,2.359-6.65,8.83L1.85,38h34.3L35.99,36.86z M4.18,36c0.81-4.3,2.28-4.9,5.24-6.12  c0.62-0.25,1.29-0.53,2-0.86c1.09-0.5,2.01-0.949,2.73-1.479c0.8-0.56,1.36-1.22,1.64-2.12C16.76,25.78,17.83,26,19,26  s2.24-0.22,3.21-0.58c0.28,0.9,0.84,1.561,1.64,2.12c0.721,0.53,1.641,0.979,2.73,1.479c0.71,0.33,1.38,0.61,2,0.86  c2.96,1.22,4.43,1.83,5.24,6.12H4.18z"></path>
                                                    </svg>Profile Page
                                                </a>
                                                <a href="{{url("/security")}}" class="list-group-item list-group-item-action border-0 ">
                                                ...
                                                <a href="{{url("/identification")}}" class="list-group-item list-group-item-action border-0 ">
                                                ...
                                                <a href="{{url("/referral")}}" class="list-group-item list-group-item-action border-0 ">
                                                    <svg xmlns="http://www.w3.org/2000/svg"  x="0px" y="0px" width="24px" height="24px" viewBox="0 0 32 32" class="me-3">
                                                ...
                                                <a href="{{url("/change-password")}}" class="list-group-item list-group-item-action border-0 ">
                                                    <svg xmlns="http://www.w3.org/2000/svg"  x="0px" y="0px" width="24px" height="24px" viewBox="0 0 24 24" class="me-3">
                                    ...
                                    <div class="card-body p-3">
                                        <div class="row g-3">
                                            <div class="d-none d-lg-block col-lg-2 text-start">
                                                ...
                                                <img src="profile-assets/images/qr-code.png" alt="Download App" class="img-fluid">
                                            </div>
                                            <div class="col-lg-10">
                            ...
                            <div class="col-lg-8 col-sm-12">
                                ...
                                <div class="bd-example mb-5">
                                    <div class="card" style="width: 18rem;">
                                        <img class="card-img-top" src="side-page-assets/images/gallery/1.jpg" alt="" />
                                        <div class="card-body">
    ...
    &lt;/div&gt;</code>
                                ...
                                <div class="bd-example mb-5">
                                    <div class="card" style="width: 18rem;">
                                        <img class="card-img-top" src="side-page-assets/images/gallery/2.jpg" alt="" />
    ...
    &lt;/div&gt;</code>
                                ...
                                <div class="bd-example mb-5">
                                    <div class="card" style="width: 18rem;">
                                        <img class="card-img-top" src="side-page-assets/images/gallery/6.jpg" alt="" />
                                        <div class="card-body">
                                            <h5 class="card-title">Card title</h5>
                                            <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                                        </div>
    ...
    &lt;/div&gt;</code>
                                ...
                                <div class="bd-example mb-5">
                                    <div class="card mb-3">
                                        <img class="card-img-top" src="side-page-assets/images/gallery/10.jpg" alt="" />
                                    ...
                                    <div class="card">
                                        ...
                                        <img class="card-img-top" src="side-page-assets/images/gallery/8.jpg" alt="" />
    ...
    &lt;/div&gt;</code>
                                ...
                                <div class="bd-example mb-5">
                                    <div class="card mb-3">
                                        <div class="row g-0">
                                            <div class="col-md-4">
                                                <img class="card-img-top" src="side-page-assets/images/gallery/5.jpg" alt="" />
                                            </div>
                                            <div class="col-md-8">
                                                <div class="card-body">
                                                    <h5 class="card-title">Card title</h5>
    ...
    &lt;/div&gt;</code>
                                ...
                                <div class="bd-example mb-5">
                                    <div class="row row-cols-1 row-cols-md-2 g-4">
                                        ...
                                        <div class="col">
                                            <div class="card">
                                                <img class="card-img-top" src="side-page-assets/images/gallery/9.jpg" alt="" />
                                                <div class="card-body">
                                                    <h5 class="card-title">Card title</h5>
                                                    <p class="card-text">This is a longer card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
                                                </div>
                                        ...
                                        <div class="col">
                                            <div class="card">
                                                <img class="card-img-top" src="side-page-assets/images/gallery/3.jpg" alt="" />
                                                <div class="card-body">
                                                    <h5 class="card-title">Card title</h5>
                                                    <p class="card-text">This is a longer card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
                                                </div>
    ...
    &lt;/div&gt;</code>
                                ...
                                <div class="bd-example mb-5">
                                    <div class="row row-cols-1 row-cols-md-3 g-4">
                                        ...
                                        <div class="col">
                                            <div class="card h-100">
                                                <img class="card-img-top" src="side-page-assets/images/gallery/7.jpg" alt="" />
                                                <div class="card-body">
                                                    <h5 class="card-title">Card title</h5>
                                                    <p class="card-text">This is a longer card with supporting text below as a natural lead-in to additional content.</p>
                                                </div>
                                        ...
                                        <div class="col">
                                            <div class="card h-100">
                                                <img class="card-img-top" src="side-page-assets/images/gallery/4.jpg" alt="" />
                                                <div class="card-body">
                                                    <h5 class="card-title">Card title</h5>
                                                    <p class="card-text">This is a longer card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
                                                </div>
    ...
    <script src="side-page-assets/plugin/prism/prism.js"></script>
