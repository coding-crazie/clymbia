...
<head>
    ...
    <title>::Refundments:: Ui Carousel </title>
                                            ...
                                            <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
                                                <div class="carousel-inner">
                                                    <div class="carousel-item active">
                                                        <img class="img-fluid" src="side-page-assets/images/gallery/10.jpg" alt="" />
                                                    </div>
                                                    <div class="carousel-item">
                                                        <img class="img-fluid" src="side-page-assets/images/gallery/8.jpg" alt="" />
                                                    </div>
                                                    <div class="carousel-item">
                                                        <img class="img-fluid" src="side-page-assets/images/gallery/1.jpg" alt="" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="card-body">
                                            <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
                                                ...
                                                <div class="carousel-inner">
                                                    ...
                                                    <div class="carousel-item">
                                                        <img class="img-fluid" src="side-page-assets/images/gallery/2.jpg" alt="" />
                                                        <div class="carousel-caption d-none d-md-block">
                                                    ...
                                                    <div class="carousel-item">
                                                        <img class="img-fluid" src="side-page-assets/images/gallery/3.jpg" alt="" />
                                                        <div class="carousel-caption d-none d-md-block">
                                            ...
                                            <div id="carouselExampleInterval" class="carousel slide" data-bs-ride="carousel">
                                                <div class="carousel-inner">
                                                    ...
                                                    <div class="carousel-item active carousel-item-left" data-interval="2000">
                                                        <img class="img-fluid" src="side-page-assets/images/gallery/5.jpg" alt="" />
                                                    </div>
                                                    <div class="carousel-item carousel-item-next carousel-item-left">
                                                        <img class="img-fluid" src="side-page-assets/images/gallery/7.jpg" alt="" />
                                                    </div>
                                                </div>
                                        ...
                                        <div class="card-body">
                                            <div id="carouselExampleDark" class="carousel carousel-dark slide" data-bs-ride="carousel">
                                                ...
                                                <div class="carousel-inner">
                                                    ...
                                                    <div class="carousel-item carousel-item-next carousel-item-left">
                                                        <img class="img-fluid" src="side-page-assets/images/gallery/6.jpg" alt="" />
                                                        <div class="carousel-caption d-none d-md-block">
                                                            <h5>Third slide label</h5>
                                                            <p>Praesent commodo cursus magna, vel scelerisque nisl consectetur.</p>
                                                        </div>
