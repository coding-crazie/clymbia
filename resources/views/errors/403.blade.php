...
<script>
  ...
  gtag('config', 'G-3KZV2TPM7F');
    ...
    <title>::Clymbia:: Suspicious</title>
                ...
                <div class="container-xxl">
                    <div class="row g-3 align-items-center">
                        <div class="col-lg-6 d-none d-lg-flex justify-content-center align-items-center auth-h100">
                            <img src="side-page-assets/images/not_found.svg" class="img-fluid" alt="#"/>
                        </div>
                        <div class="col-lg-6 d-flex justify-content-center align-items-center auth-h100 flex-column">
                            <div class="card" style="max-width: 30rem;">
                                <div class="card-body p-4">
                                    <h1 class="display-1">Oh No!</h1>
                                    <span class="text-muted">Our System detects <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 14" height="24" width="24"><path fill="#f4195f" stroke="#262222" stroke-linejoin="round" d="M1.25495 10.4795L5.20388 2.41708C5.93548 0.923392 8.06453 0.923393 8.79613 2.41708L12.745 10.4795C12.918 10.8325 13.0558 11.2289 12.7034 11.5097C11.0468 12.8301 2.95317 12.8301 1.29657 11.5097C0.94375 11.2285 1.08021 10.8362 1.25495 10.4795Z"></path><path stroke="#262222" stroke-linecap="round" stroke-linejoin="round" d="M7 5V7.5"></path><path stroke="#262222" stroke-linecap="round" stroke-linejoin="round" d="M7 9.75L7 10"></path></svg>  the unauthorized User who is trying to reach our admin panel and you are the only one here, who are you  <svg viewBox="0 0 48 48" height="50" width="50" xmlns="http://www.w3.org/2000/svg"><path d="M4.000 21.500 A20.000 20.000 0 1 0 44.000 21.500 A20.000 20.000 0 1 0 4.000 21.500 Z" fill="#ffe500"></path><path d="M24,1.5a20,20,0,1,0,20,20A20,20,0,0,0,24,1.5Zm0,37A18.25,18.25,0,1,1,42.25,20.25,18.25,18.25,0,0,1,24,38.5Z" fill="#ebcb00"></path><path d="M18.000 5.500 A6 1.5 0 1 0 30.000 5.500 A6 1.5 0 1 0 18.000 5.500 Z" fill="#fff48c"></path><path d="M8.000 45.500 A16 1.5 0 1 0 40.000 45.500 A16 1.5 0 1 0 8.000 45.500 Z" fill="#45413c" opacity=".15"></path><path d="M4.000 21.500 A20.000 20.000 0 1 0 44.000 21.500 A20.000 20.000 0 1 0 4.000 21.500 Z" fill="none" stroke="#45413c" stroke-linecap="round" stroke-linejoin="round"></path><path d="M38.5,23.5c0,.83-1.12,1.5-2.5,1.5s-2.5-.67-2.5-1.5S34.62,22,36,22,38.5,22.67,38.5,23.5Z" fill="#ffaa54"></path><path d="M9.5,23.5c0,.83,1.12,1.5,2.5,1.5s2.5-.67,2.5-1.5S13.38,22,12,22,9.5,22.67,9.5,23.5Z" fill="#ffaa54"></path><path d="M30.35,30c-1.47-1.49-4.21-2.5-7.35-2.5a13.43,13.43,0,0,0-2.5.23" fill="none" stroke="#45413c" stroke-linecap="round" stroke-linejoin="round"></path><path d="M17.670 19.000 A1.000 1.000 0 1 0 19.670 19.000 A1.000 1.000 0 1 0 17.670 19.000 Z" fill="#45413c" stroke="#45413c" stroke-linecap="round" stroke-linejoin="round"></path><path d="M27.000 19.030 A1.000 1.000 0 1 0 29.000 19.030 A1.000 1.000 0 1 0 27.000 19.030 Z" fill="#45413c" stroke="#45413c" stroke-linecap="round" stroke-linejoin="round"></path><path d="M21,15.5s-3-4.5-6.33-3" fill="none" stroke="#45413c" stroke-linecap="round" stroke-linejoin="round"></path><path d="M33.5,15.5a11.77,11.77,0,0,1-6.95.83" fill="none" stroke="#45413c" stroke-linecap="round" stroke-linejoin="round"></path></svg></span>
                                    <a href="{{url('')}}" title="#" class="btn btn-primary text-uppercase py-2 fs-5 mt-3 d-block">Please Go back to Safety</a>
                                </div>
                            </div>
                        </div>
                    </div> <!-- End Row -->
