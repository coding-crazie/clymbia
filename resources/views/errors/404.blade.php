                        ...
                        <div class="col-lg-6 d-flex justify-content-center align-items-center auth-h100 flex-column">
                            <div class="card" style="max-width: 30rem;">
                                <div class="card-body p-4">
                                    <h1 class="display-1">Oh No! Error 404</h1>
                                    <span class="text-muted">Maybe Bigfoot has broken this page.Come back to the homepage</span>
                                    <a href="{{url('/')}}" title="#" class="btn btn-primary text-uppercase py-2 fs-5 mt-3 d-block">Back to Homepage</a>
                                </div>
                            </div>
                        </div>
                    </div> <!-- End Row -->
