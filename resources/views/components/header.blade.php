    ...
    <nav class="navbar py-4">
      ...
      <div style="width: 200px;">
        ...
        <script type="text/javascript" src="//translate.google.com/translate_a/element.js?cb=googleTranslateElementInit"></script>
                            ...
                            <!-- Language Translator Ends -->
            <!-- header rightbar icon -->
            <div class="h-right d-flex align-items-center mr-5 mr-lg-0 order-1">
                <div class="d-flex">
                    <a class="nav-link text-primary collapsed" href="{{url("/dashboard")}}" title="Wallet">
                        ...
                        <div class="card border-0 w280">
                            ...
                            <div class="list-group m-2 ">
                                @can('isAdmin')
                                    ...
                                    <a href="{{url("/admins")}}" class="list-group-item list-group-item-action border-0">
                                ...
                                {{-- <a href="{{url("/referral")}}" class="list-group-item list-group-item-action border-0 ">
                                 ...
                                 <a href="{{url("/change-password")}}" class="list-group-item list-group-item-action border-0 ">
                                    <object data="/images/unlock.svg"> </object>  &nbsp Change My Password
                                </a>
                                <a href="{{url("/change-email")}}" class="list-group-item list-group-item-action border-0 ">
                                    <object data="/images/unlock.svg"> </object> &nbsp  Change My Email
                                </a>
