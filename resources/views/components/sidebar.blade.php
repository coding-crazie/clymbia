  <div class="sidebar py-2 py-md-2 me-0 border-end">
            <div class="d-flex flex-column h-100">
                ...
                <ul class="menu-list flex-grow-1 mt-4 px-1">
                    ...
                    <li>
                        <a class="m-link" href="{{url("/all-requests")}}">
                            ...
                            <div><h6 class="mb-0">All Requests</h6><small class="text-muted">All Requests</small></div>
                        </a>
                    </li>
                    <li>
                        <a class="m-link " href="{{url("/exchange")}}">
                            <svg xmlns="http://www.w3.org/2000/svg"  x="0px" y="0px" width="24px" height="24px" viewBox="0 0 38 38">
                    ...
                    <li>
                        <a class="m-link" href="{{url("/future-trade")}}">
                            <svg  xmlns="http://www.w3.org/2000/svg"  x="0px" y="0px" width="24px" height="24px" viewBox="0 0 64 64">
                    ...
                    <li class="collapsed">
                        <a class="m-link" data-bs-toggle="collapse" data-bs-target="#finace" href="#">
                            ...
                            <div><h6 class="mb-0">Finance</h6><small class="text-muted">Investment Solution</small></div><span class="arrow icofont-rounded-down ms-auto text-end fs-5"></span>
                        </a>
                        <!-- Menu: Sub menu ul -->
