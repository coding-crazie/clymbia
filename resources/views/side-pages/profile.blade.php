...
<script>
  ...
  gtag('config', 'G-3KZV2TPM7F');
    ...
    <title>::Refundments::  Admin Profile </title>   
                            ...
                            <div class="card profile-card flex-column mb-3">
                                ...
                                <div class="card-body d-flex profile-fulldeatil flex-column">
                                    <div class="profile-user text-center w220 mx-auto">
                                        <a href="#">
                                            <img src="side-page-assets/images/lg/avatar4.svg" alt="" class="avatar xl rounded img-thumbnail shadow-sm">
                                        </a>
                                        ...
                                        <div class="row g-2 pt-2">
                                            ...
                                            <div class="col-xl-12">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <span class="ms-2">{{ Auth::user()->created_at }}</span>
                                                </div>
                                            </div>
                                            <div class="col-xl-12">
                                                <div class="d-flex align-items-center">
                        ...
                        <div class="deadline-form">
                            <form>
                                ...
                                <div class="row g-3 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="mailid" value="{{ Auth::user()->email }}">
                                    </div>
                                    <div class="col-sm-6">
