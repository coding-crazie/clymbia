...
<script>
  ...
  gtag('config', 'G-3KZV2TPM7F');
    ...
    <title>::Refundments::  Exchange </title>
...
<body>
                ...
                <div class="container-xxl">
                    <div class="row align-items-center g-2">
                        ...
                        <div class="col-md-6 col-lg-6 col-xl-4">
                            <a href="{{url('https://moonpay.com/buy')}}" title="invite" class="btn btn-primary text-dark mb-1">Exchange Rate Fee</a>
                            {{-- <a href="{{url('add-bank')}}" title="Exchange rate fee" class="d-block"><i class="icofont-twitter px-1 fs-6 color-lightblue"></i>Add Your Bank Account for New Withdraw</a> --}}
                        </div>
    ...
    <script  src="side-page-js/js/page/exchange.js"></script>
</body>
</html> 