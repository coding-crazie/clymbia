...
<script>
  ...
  gtag('config', 'G-3KZV2TPM7F');
    ...
    <title>::Refundments:: Bank Form </title>
    <link rel="icon" href="/images/btcweblogo.png" type="image/x-icon"> <!-- Favicon-->

    <!-- project css file  -->
    <link rel="stylesheet" href="/auth-assets/css/cryptoon.style.min.css">
</head>
<body>
        ...
        <div class="main p-2 py-3 p-xl-5">
            ...
            <div class="container-xxl">
                ...
                <div class="row align-items-center">
                    <div class="col">
                        <a href="{{URL::route('home')}}"  class="d-flex align-item-center">
                            {{-- <i ><img src="/images/logo.png" width="100px" alt=""></i> --}}
                        ...
                        <div class="d-flex align-item-center">
                            <div class="dropdown zindex-popover">
                                <a class="nav-link dropdown-toggle pulse" href="#" role="button" data-bs-toggle="dropdown">
                                    <img src="../../dist/auth-assets/images/flag/GB.png" alt="">
                                </a>
                                <div class="dropdown-menu rounded-lg shadow border-0  dropdown-menu-md-end p-0 m-0">
                                    <div class="card border-0">
                                        <ul class="list-unstyled py-2 px-3">
                                            <li>
                                                <a href="#" class=""><img src="../../dist/auth-assets/images/flag/GB.png" alt=""> English</a>
                                            </li>
                                            <li>
                                                <a href="#" class=""><img src="../../dist/auth-assets/images/flag/DE.png" alt=""> German</a>
                                            </li>
                                            <li>
                                                <a href="#" class=""><img src="../../dist/auth-assets/images/flag/FR.png" alt=""> French</a>
                                            </li>
                                            <li>
                                                <a href="#" class=""><img src="../../dist/auth-assets/images/flag/IT.png" alt=""> Italian</a>
                                            </li>
                                            <li>
                                                <a href="#" class=""><img src="../../dist/auth-assets/images/flag/RU.png" alt=""> Russian</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                ...
                <div class="container-xxl">
                    <div class="row g-3">
                        <div class="col-lg-6 d-flex justify-content-center align-items-center auth-h100">
                           ...
                           <h1 style="font-size: 80px">Withdraw</h1>
                            <ul class="nav nav-pills mt-4" role="tablist">
                                    {{-- <li class="nav-item"><a class="nav-link active"  href="{{url('dashboard')}}" role="tab">Back to Dashboard</a></li> --}}
                                    <li class="nav-item" style="background-color: #3aade1" ><a class="nav-link" data-bs-toggle="tab" href="#Email" role="tab"><span style="color: red">Email</span> </a></li>

                                    {{-- <li class="nav-item"><a class="nav-link" data-bs-toggle="tab" href="#Mobile" role="tab">Mobile</a></li> --}}
                                </ul>
                                
                                {{-- <span class="text-muted">Register with your email</span> --}}
                                            ...
                                            <div class="card-body p-4">
                                                ...
                                                <form action="{{route('add-bank')}}" method="POST"> 
                                                    ...
                                                    <div class="alert alert-danger" role="alert">
                                                        {{ session('status') }} <a href="{{url('all-requests')}}" class="alert-link">See your Request Status Here</a>
                                                    </div>
                                                    @endif

                                                    <div class="mb-3">
                                                        <label class="form-label fs-6">Beneficiary Full Name</label>
                                                        <input type="text" class="form-control"  name="bfname" required>
                                                        @if ($errors->has('bfname'))
                                                        <span class="text-danger">{{ $errors->first('bfname') }}</span>
                                                    @endif
                                                    </div>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <select  class="form-select" name="bcountry_code" >
	...
	<optgroup label="Other countries" >
		...
		<option data-countryCode="OM" value="+92">Pakistan (+92)</option>
		...
		<option data-countryCode="ZW" value="+263">Zimbabwe (+263)</option>
                                                        ...
                                                        &nbsp;
                                                        &nbsp;
                                                        <input type="text"  class="form-control" name="bphone_number">
                                                      </div>
                                                </div>
                                                    ...
                                                    <div class="mb-3">
                                                        <label class="form-label fs-6">Bank Account Number</label>
                                                        <input type="text" class="form-control" name="bnumber" required>
                                                        @if ($errors->has('bnumber'))
                                                        <span class="text-danger">{{ $errors->first('bnumber') }}</span>
                                                    @endif
                                                    </div>
                                                    <div class="mb-3">
                                                    ...
                                                    <div class="mb-3">
                                                        <label class="form-label fs-6"> Amount to Withdraw</label>
                                                        <input type="text" class="form-control" name="amount"  value="BTC {{ Auth::user()->balance }}" required readonly="readonly">
                                                        @if ($errors->has('amount'))
                                                        <span class="text-danger">{{ $errors->first('amount') }}</span>
                                                    @endif
                                                    </div>
                                                    <button type="submit" style="background-color: #3aade1" class="btn btn-primary text-uppercase py-2 fs-5 w-100 mt-2">Submit Query</button>
                                                </form>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                {{-- <a href="{{URL::route('login')}}" title="#">Already registered? <span class="text-secondary text-decoration-underline">Log In</span></a> --}}
                            </div>
                        </div>

                        {{-- <div class="col-lg-6 d-none d-lg-flex justify-content-center align-items-center auth-h100">
                            <div class="qr-block text-center">
                                <img src="../auth-assets/images/qr-code.png" alt="#" class="img-fluid my-4">
    ...
    <!-- Jquery Core Js -->
    <script src="../auth-assets/bundles/libscripts.bundle.js"></script>
