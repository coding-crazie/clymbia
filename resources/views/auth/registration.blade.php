                ...
                <div class="row align-items-center">
                    <div class="col">
                        <a href="{{URL::route('home')}}"  class="d-flex align-item-center">
                            <i ><img src="/images/logo.png" width="300px" alt=""></i>
                    ...
                    <div class="row g-3">
                        <div class="col-lg-6 d-flex justify-content-center align-items-center auth-h100">
                            <div class="d-flex flex-column">
                                        ...
                                        <div class="card">
                                            <div class="card-body p-4">
                                                <form action="{{ route('register.post') }}" method="POST"> 
                                                    ...
                                                    <button type="submit" style="background-color: #3aade1" class="btn btn-primary text-uppercase py-2 fs-5 w-100 mt-2">Create Account</button>
                                                </form>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <a href="{{URL::route('login')}}" title="#">Already registered? <span class="text-secondary text-decoration-underline"><span style="color: #3aade1">Login</span></span></a>
                            </div>
                        </div>
