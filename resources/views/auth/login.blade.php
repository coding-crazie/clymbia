                    ...
                    <div class="row g-3">
                        <div class="col-lg-6 d-flex justify-content-center align-items-center auth-h100">
                            <div class="d-flex flex-column">
                                <h1>Account Login</h1>
                                <span class="text-muted">Welcome back! Log In with your Email Please </span>
                                        ...
                                        <div class="card">
                                            <div class="card-body p-4">
                                                <form action="{{ route('login.post') }}" method="POST">
                                                    ...
                                                    <button type="submit"  name="remember"  style="background-color: #3aade1" class="btn btn-primary text-uppercase py-2 fs-5 w-100 mt-2">log in</button>
                                                </form>
                                ...
                                <a href="{{URL::route('register')}}" title="#" class=" text-decoration-underline"><span style="color: #3aade1">Not Registered Now</span></a>
                            </div>
                        </div>
